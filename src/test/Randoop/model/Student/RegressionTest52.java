...
public class RegressionTest52 {
    ...
    public void test26321() throws Throwable {
        ...
        student3.login("hi!", "student");
        student3.login("hi!", "");
        java.lang.String str33 = student3.getAccountType();
        double double34 = student3.getHourlyRate();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "student" + "'", str5, "student");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26344() throws Throwable {
        ...
        student3.setVerified(true);
        java.lang.String str32 = student3.getID();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "student" + "'", str5, "student");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26442() throws Throwable {
        ...
        student3.login("hi!", "student");
        student3.login("hi!", "");
        java.lang.String str33 = student3.getEmail();
        student3.login("hi!", "student");
        student3.viewProfile();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "student" + "'", str5, "student");
    ...
    public void test26485() throws Throwable {
        ...
        student3.login("hi!", "student");
        student3.login("hi!", "student");
        double double30 = student3.getHourlyRate();
