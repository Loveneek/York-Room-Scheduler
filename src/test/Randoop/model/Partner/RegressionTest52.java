...
public class RegressionTest52 {
    ...
    public void test26305() throws Throwable {
        ...
        java.lang.String str31 = partner3.getAccountType();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "partner" + "'", str5, "partner");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str10 + "' != '" + "hi!" + "'", str10, "hi!");
        ...
        org.junit.Assert.assertEquals("'" + str31 + "' != '" + "partner" + "'", str31, "partner");
    }
    ...
    public void test26336() throws Throwable {
        ...
        partner3.login("hi!", "partner");
        partner3.login("hi!", "");
        java.lang.String str33 = partner3.getAccountType();
        double double34 = partner3.getHourlyRate();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "partner" + "'", str5, "partner");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
        ...
        org.junit.Assert.assertTrue("'" + boolean17 + "' != '" + false + "'", boolean17 == false);
        org.junit.Assert.assertEquals("'" + str18 + "' != '" + "partner" + "'", str18, "partner");
        org.junit.Assert.assertEquals("'" + str33 + "' != '" + "partner" + "'", str33, "partner");
    ...
    public void test26359() throws Throwable {
        ...
        partner3.login("", "hi!");
        double double28 = partner3.getHourlyRate();
        double double29 = partner3.getHourlyRate();
        partner3.setVerified(true);
        java.lang.String str32 = partner3.getID();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "partner" + "'", str5, "partner");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26457() throws Throwable {
        ...
        partner3.login("hi!", "partner");
        partner3.login("hi!", "");
        java.lang.String str33 = partner3.getEmail();
        partner3.login("hi!", "partner");
        partner3.viewProfile();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "partner" + "'", str5, "partner");
    ...
    public void test26500() throws Throwable {
        ...
        partner3.login("hi!", "partner");
        partner3.login("hi!", "partner");
        double double30 = partner3.getHourlyRate();
        java.lang.String str31 = partner3.getID();
        java.lang.Class<?> wildcardClass32 = partner3.getClass();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "partner" + "'", str5, "partner");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
