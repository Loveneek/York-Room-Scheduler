...
public class RegressionTest52 {
    ...
    public void test26175() throws Throwable {
        ...
        model.Staff staff3 = new model.Staff("hi!", "staff", "hi!");
        double double4 = staff3.getHourlyRate();
        java.lang.String str5 = staff3.getID();
        java.lang.String str6 = staff3.getEmail();
        java.lang.String str7 = staff3.getID();
    ...
    public void test26263() throws Throwable {
        ...
        java.lang.String str31 = staff3.getAccountType();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "staff" + "'", str5, "staff");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str10 + "' != '" + "hi!" + "'", str10, "hi!");
    ...
    public void test26294() throws Throwable {
        ...
        staff3.login("hi!", "staff");
        staff3.login("hi!", "");
        java.lang.String str33 = staff3.getAccountType();
        double double34 = staff3.getHourlyRate();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "staff" + "'", str5, "staff");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26317() throws Throwable {
        ...
        staff3.setVerified(true);
        java.lang.String str32 = staff3.getID();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "staff" + "'", str5, "staff");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26415() throws Throwable {
        ...
        staff3.login("hi!", "staff");
        staff3.login("hi!", "");
        java.lang.String str33 = staff3.getEmail();
        staff3.login("hi!", "staff");
        staff3.viewProfile();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "staff" + "'", str5, "staff");
    ...
    public void test26458() throws Throwable {
        ...
        staff3.login("hi!", "staff");
        staff3.login("hi!", "staff");
        double double30 = staff3.getHourlyRate();
        java.lang.String str31 = staff3.getID();
        java.lang.Class<?> wildcardClass32 = staff3.getClass();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "staff" + "'", str5, "staff");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
