...
public class RegressionTest52 {
    ...
    public void test26361() throws Throwable {
        ...
        faculty3.login("hi!", "faculty");
        faculty3.login("hi!", "");
        java.lang.String str33 = faculty3.getAccountType();
        double double34 = faculty3.getHourlyRate();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "faculty" + "'", str5, "faculty");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26384() throws Throwable {
        ...
        faculty3.setVerified(true);
        java.lang.String str32 = faculty3.getID();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "faculty" + "'", str5, "faculty");
        org.junit.Assert.assertTrue("'" + boolean6 + "' != '" + false + "'", boolean6 == false);
        org.junit.Assert.assertEquals("'" + str8 + "' != '" + "" + "'", str8, "");
    ...
    public void test26482() throws Throwable {
        ...
        faculty3.login("hi!", "faculty");
        faculty3.login("hi!", "");
        java.lang.String str33 = faculty3.getEmail();
        faculty3.login("hi!", "faculty");
        faculty3.viewProfile();
        org.junit.Assert.assertEquals("'" + str4 + "' != '" + "hi!" + "'", str4, "hi!");
        org.junit.Assert.assertEquals("'" + str5 + "' != '" + "faculty" + "'", str5, "faculty");
